...
use super::impls::{BaseType, ForeignKey};
use types::Type;
...
/// A foreign key constraint to another table
pub fn foreign_key(fk: ForeignKey) -> Type {
        Type::new(BaseType::ForeignKey(fk)).nullable(true)
}
